    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-4 py-2 border-b border-gray-100 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-gray-600 min-w-[5rem] text-center tabular-nums">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            onClick={resetZoom}
            className="p-1.5 rounded-lg hover:bg-gray-100 transition-colors text-xs font-medium"
            title="Reset zoom"
          >
            Fit
          </button>
      ...
      <div className="flex-1 overflow-auto bg-gray-50/50 p-4 flex justify-center">
