...
const DocxRenderer: React.FC<DocxRendererProps> = ({ src, fileName }) => {
  ...
  return (
    <div className="h-full overflow-auto bg-white p-6 sm:p-10">
      <div
        ref={containerRef}
        className="prose prose-sm max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-indigo-600 prose-img:rounded-lg prose-strong:text-gray-900"
