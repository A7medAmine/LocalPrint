  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 1px 3px rgba(0,0,0,0.06), 0 12px 32px rgba(0,0,0,0.06)',
        'modal': '0 4px 6px rgba(0,0,0,0.04), 0 20px 60px rgba(0,0,0,0.08)',
        'sidebar': '2px 0 12px rgba(0,0,0,0.04)',
        'topbar': '0 1px 3px rgba(0,0,0,0.02), 0 1px 2px rgba(0,0,0,0.04)',
